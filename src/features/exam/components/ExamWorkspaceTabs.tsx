...
function InsightPanel({
  ...
  return (
    <Tabs defaultValue="weakness" className="gap-0">
      <TabsList className="liquid-glass-control grid w-full max-w-[300px] grid-cols-3 rounded-lg p-1">
          ...
          <div className="rounded-lg border border-border/70 bg-background/35 p-4">
            ...
            {microUnit && (
              <div className="mt-4 rounded-md border border-border/60 bg-background/50 p-3">
                ...
                <p className="mt-1 text-sm text-foreground">{getExamUnitTitle(microUnit)}</p>
