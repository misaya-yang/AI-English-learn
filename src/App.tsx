...
const WritingPage = lazyWithRetry(() => import('@/pages/dashboard/WritingPage'), 'writing');
const LearningPathPage = lazyWithRetry(() => import('@/pages/dashboard/LearningPathPage'), 'learning-path');
