...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    features: [
      ...
      'Limited AI coach and exam feedback quota',
  ...
  },
  {
    ...
    period: 'per month',
    features: [
      'Unlimited AI coach with recovery handoffs',
      'IELTS Writing and Speaking scoring rubrics',
      'Advanced analytics: review debt, skill trends, error graph',
      'Custom wordbook imports plus Anki / CSV export',
      'Weekly plan and evidence recap',
    ],
    featuresZh: [
      '不限量 AI 教练与错题恢复接力',
      'IELTS 写作与口语评分量表',
